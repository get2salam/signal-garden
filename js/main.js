  ...
  "slug": "signal-garden",
  "title": "Signal Garden",
  "tagline": "Collect promising ideas, tag their signal strength, and decide what to nurture.",
  "domainLabel": "signals",
  "itemLabel": "signal",
  "emptyTitle": "No signals yet",
  "emptyBody": "Capture stray ideas before they vanish, then score what is actually promising.",
  "seedTitle": "Idea signal board",
  "seedSubtitle": "A calmer way to separate sparks from real opportunities.",
  "categories": [
    "Audience",
    "Product",
    "Growth",
  ...
  "items": [
    {
      ...
      "score": 7,
      "effort": 4,
      "note": "Interesting edge audience with high pain, but monetization still feels weak."
    },
    {
      "title": "Shareable case summary cards",
      "category": "Growth",
      "state": "Strong",
      "score": 9,
      "effort": 3,
      "note": "Turns research into a visible loop and could compound distribution."
    },
    {
      "title": "Auto-tagging old notes",
      "category": "Ops",
      "state": "Seed",
      "score": 6,
      "effort": 5,
      "note": "Useful internally, but unclear whether the payoff beats the build time."
    }
  ]
};
